...
from gui_tool.gui_json_copy import auto_suggest_jsons_path, import_dispersion_json, import_jsons, import_area_json
from gui_tool.gui_calc_trajectory import RunTrajectoryThread
from gui_tool.gui_calc_area import RunAreaThread
from gui_tool.gui_calc_dispersion import RunDispersionThread
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __set_ui(self):
        ...
        self.ui.pushButton_dispersion_config_json.clicked.connect(lambda: self.ui.label_dispersion_config_json.setText(self.select_file_dialog()))
        ...
        self.ui.pushButton_dispersion_calc.clicked.connect(lambda: self.run_calc_dispersion())
    ...
    def show_about(self):
        ...
        msgBox.setText('ForRocket Workbench v1.2.0 licensed GPL-v3                                                 ')
