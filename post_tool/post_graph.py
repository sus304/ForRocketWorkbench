...
def plot_graph(df_all, df_burning, df_coasting, file_prefix):
    ...
    plt.figure()
    plt.plot(df_burning["Time [s]"], df_burning["TotalAoA [deg]"], color='orangered', linestyle='solid', label='TotalAoA-burning')
    plt.plot(df_coasting["Time [s]"], df_coasting["TotalAoA [deg]"], color='royalblue', linestyle='solid', label='TotalAoA-coasting')
    plt.plot(df_burning["Time [s]"], df_burning["TrimAoA [deg]"], color='orangered', linestyle='dashed', label='TrimAoA-burning')
    plt.plot(df_coasting["Time [s]"], df_coasting["TrimAoA [deg]"], color='royalblue', linestyle='dashed', label='TrimAoA-coasting')
    plt.xlabel("Time [s]")
    plt.ylabel("AoA [deg]")
    plt.xlim(start_time, end_time)
    plt.grid()
    plt.legend()
    plt.savefig(file_prefix + "_spin_total_trim_aoa.png")
    plt.close()

    plt.figure()
    plt.plot(df_burning["Time [s]"], df_burning["SpinFreq [Hz]"], color='orangered', linestyle='solid', label='SpinFreq-burning')
    plt.plot(df_coasting["Time [s]"], df_coasting["SpinFreq [Hz]"], color='royalblue', linestyle='solid', label='SpinFreq-coasting')
    plt.plot(df_burning["Time [s]"], df_burning["PitchYawNaturalFreq [Hz]"], color='orangered', linestyle='dashed', label='PitchYawNatFreq-burning')
    plt.plot(df_coasting["Time [s]"], df_coasting["PitchYawNaturalFreq [Hz]"], color='royalblue', linestyle='dashed', label='PitchYawNatFreq-coasting')
    plt.xlabel("Time [s]")
    plt.ylabel("Frequency [Hz]")
    plt.xlim(start_time, end_time)
    plt.grid()
    plt.legend()
    plt.savefig(file_prefix + "_spin_freq.png")
    plt.close()

    plt.figure()
    plt.plot(df_burning["Time [s]"], df_burning["ResonanceRatio [-]"], color='orangered', label='burning')
    plt.plot(df_coasting["Time [s]"], df_coasting["ResonanceRatio [-]"], color='royalblue', label='coasting')
    plt.axhline(y=1.0, color='black', linestyle='dashed', linewidth=0.8, label='resonance (Λ=1)')
    plt.xlabel("Time [s]")
    plt.ylabel("ResonanceRatio Λ [-]")
    plt.xlim(start_time, end_time)
    plt.grid()
    plt.legend()
    plt.savefig(file_prefix + "_spin_resonance_ratio.png")
    plt.close()

    plt.figure()
    plt.plot(df_burning["Time [s]"], df_burning["GyroStabilityFactor Sg [-]"], color='orangered', linestyle='solid', label='Sg-burning')
    plt.plot(df_coasting["Time [s]"], df_coasting["GyroStabilityFactor Sg [-]"], color='royalblue', linestyle='solid', label='Sg-coasting')
    plt.plot(df_burning["Time [s]"], df_burning["DynStabilityFactor Sd [-]"], color='orangered', linestyle='dashed', label='Sd-burning')
    plt.plot(df_coasting["Time [s]"], df_coasting["DynStabilityFactor Sd [-]"], color='royalblue', linestyle='dashed', label='Sd-coasting')
    plt.plot(df_burning["Time [s]"], df_burning["DynStabilityBoundary Sd(2-Sd) [-]"], color='orangered', linestyle='dashdot', label='Sd(2-Sd)-burning')
    plt.plot(df_coasting["Time [s]"], df_coasting["DynStabilityBoundary Sd(2-Sd) [-]"], color='royalblue', linestyle='dashdot', label='Sd(2-Sd)-coasting')
    plt.axhline(y=1.0, color='black', linestyle='dashed', linewidth=0.8, label='Sg=1 boundary')
    plt.xlabel("Time [s]")
    plt.ylabel("Stability Factor [-]")
    plt.xlim(start_time, end_time)
    plt.grid()
    plt.legend()
    plt.savefig(file_prefix + "_spin_stability_factors.png")
    plt.close()

    plt.figure()
    plt.plot(df_burning["Time [s]"], df_burning["LateralAeroLoad [N]"], color='orangered', label='burning')
    plt.plot(df_coasting["Time [s]"], df_coasting["LateralAeroLoad [N]"], color='royalblue', label='coasting')
    plt.xlabel("Time [s]")
    plt.ylabel("LateralAeroLoad [N]")
    plt.xlim(start_time, end_time)
    plt.grid()
    plt.legend()
    plt.savefig(file_prefix + "_spin_lateral_aero_load.png")
    plt.close()
